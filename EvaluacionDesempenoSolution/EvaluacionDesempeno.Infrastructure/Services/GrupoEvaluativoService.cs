...
{
    public class GrupoEvaluativoService : BaseService<GrupoEvaluativo>, IGrupoEvaluativoService
    {
        public GrupoEvaluativoService(AppDbContext context) : base(context)
        {
        }
    }
}
