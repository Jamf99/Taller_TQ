...
{
    public class ModeloEvaluativoService : BaseService<ModeloEvaluativo>, IModeloEvaluativoService
    {
        public ModeloEvaluativoService(AppDbContext context) : base(context)
        {
        }
    }
}
